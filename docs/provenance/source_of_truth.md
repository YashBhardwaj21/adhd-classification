...
- **Staged Result Artifacts**:
  - [`results/exp01/dynamic_manifest.csv`](../../results/exp01/dynamic_manifest.csv): 1,193 acquisitions across 764 subjects from 9 sites.
  - [`results/exp01/dynamic_temporal_validation.csv`](../../results/exp01/dynamic_temporal_validation.csv): Per-subject temporal lag similarity and Frobenius distance for lags 1 to 4.
  - [`results/exp01/static_vs_dynamic_validation.csv`](../../results/exp01/static_vs_dynamic_validation.csv): 1,193 acquisitions comparing static FC against mean dynamic FC.
...
- **Canonical Notebooks**:
  - [`notebooks/exp02/02_graph_construction_and_validation.ipynb`](../../notebooks/exp02/02_graph_construction_and_validation.ipynb)
  - [`notebooks/exp02/03_graph_metrics_and_null_models.ipynb`](../../notebooks/exp02/03_graph_metrics_and_null_models.ipynb)
- **Source Scripts**:
  - [`src/exp02/graph_utils.py`](../../src/exp02/graph_utils.py): MST + Proportional Thresholding (PT) graph builder.
  - [`src/exp02/null_model_und_sign_fixed.py`](../../src/exp02/null_model_und_sign_fixed.py): Rubinov-Sporns signed degree-preserving network rewiring.
  - [`src/exp02/randmio_und_signed_fast.py`](../../src/exp02/randmio_und_signed_fast.py): Numba JIT-compiled inner loop for signed edge swapping.
  - [`src/exp02/null_model_und_sign_fast.py`](../../src/exp02/null_model_und_sign_fast.py): **Dead code** (0-byte empty file, replaced by `null_model_und_sign_fixed.py`).
- **Configuration**:
  - [`configs/exp02/graph_config.json`](../../configs/exp02/graph_config.json): density $\rho = 0.20$, nodes $N = 190$, edges $M = 3,591$, mean degree $\langle k \rangle = 37.8$.
- **Staged Result Artifacts**:
  - [`results/exp02/graph_metrics.csv`](../../results/exp02/graph_metrics.csv): Window-level graph metrics for 31,060 dynamic windows (`avg_degree`, `avg_strength`, `clustering`, `transitivity`, `global_efficiency`, `local_efficiency`, `path_length`).
  - [`results/exp02/subject_graph_metrics.csv`](../../results/exp02/subject_graph_metrics.csv): Subject-level summaries (mean, std, median, min, max) for 764 subjects.
  - [`results/exp02/site_graph_metrics.csv`](../../results/exp02/site_graph_metrics.csv): Site-level summaries across 9 scanning sites.
  - [`results/exp02/graph_construction_strategy.csv`](../../results/exp02/graph_construction_strategy.csv): Density sweep validating $\rho = 0.20$ as preserving connectivity without over-densification.
...
- **Canonical Notebook**: [`notebooks/exp03/04_dynamic_graph_feature_extraction.ipynb`](../../notebooks/exp03/04_dynamic_graph_feature_extraction.ipynb)
- **Supporting Notebook**: [`notebooks/exp04/w2c_athena_2.ipynb`](../../notebooks/exp04/w2c_athena_2.ipynb) (Phase VII-C)
- **Input**: 31,060 dynamic window graphs from Exp 2.
- **Staged Result Artifacts**:
  - [`results/exp03/subject_graph_features.csv`](../../results/exp03/subject_graph_features.csv): 764 subjects with 42 temporal features (mean, std, var, range, CV, IQR across 7 graph metrics).
  - [`results/exp03/feature_statistics.csv`](../../results/exp03/feature_statistics.csv): Window-level distribution summary across all 31,060 windows.
  - [`results/exp03/site_anova.csv`](../../results/exp03/site_anova.csv): Cross-site ANOVA statistics.
- **Audited Findings**:
...
- **Canonical Notebook**: [`notebooks/exp04/w2c_athena_2.ipynb`](../../notebooks/exp04/w2c_athena_2.ipynb)
- **Staged Result Artifacts**:
  - [`results/exp04/site_prediction_results.csv`](../../results/exp04/site_prediction_results.csv):
    - Raw Site Accuracy: **58.64%** (Balanced Acc: 50.19%, Macro F1: 50.61%)
    - ComBat Site Accuracy: **31.29%** (Balanced Acc: 23.56%, Macro F1: 24.37%)
  - [`results/exp04/diagnosis_prediction_results.csv`](../../results/exp04/diagnosis_prediction_results.csv):
  ...
  - [`results/exp04/comparison_table.csv`](../../results/exp04/comparison_table.csv): Metric distributions before and after ComBat:
  ...
  - [`results/exp04/graph_topology_preservation.csv`](../../results/exp04/graph_topology_preservation.csv): Feature correlation before and after ComBat:
    - $\lambda$: 0.9137, $E_{glob}$: 0.8838, $\gamma$: 0.8348, $\sigma$: 0.8150, $C$: 0.7712, $E_{loc}$: 0.7659, $L$: 0.4579.
  - [`results/exp04/effect_size_before_after.csv`](../../results/exp04/effect_size_before_after.csv): Kruskal-Wallis site effect size reduction.
...
- **Canonical Notebook**: [`notebooks/exp05/dynamic_transformer.ipynb`](../../notebooks/exp05/dynamic_transformer.ipynb)
- **Staged Result Artifacts**:
  - [`results/exp05/subject_feature_summary.csv`](../../results/exp05/subject_feature_summary.csv) (764 subjects):
  ...
  - [`results/exp05/run_transition_dynamics.csv`](../../results/exp05/run_transition_dynamics.csv): 1,193 acquisitions with transition counts ($C_{00}$ to $C_{22}$) and transition probabilities ($P_{00}$ to $P_{22}$).
  - [`results/exp05/run_state_sequences.csv`](../../results/exp05/run_state_sequences.csv): Complete temporal state index sequences per acquisition.
  - [`results/exp05/run_dynamic_biomarkers.csv`](../../results/exp05/run_dynamic_biomarkers.csv): Per-run occupancy, dwell, and transition rate metrics.
  - [`results/exp05/subject_dynamic_dataset.csv`](../../results/exp05/subject_dynamic_dataset.csv), [`results/exp05/subject_feature_correlation.csv`](../../results/exp05/subject_feature_correlation.csv).
...
- **Staged Result Artifact**: [`results/exp06/exp06_verified_results.json`](../../results/exp06/exp06_verified_results.json)
...
- **Source Scripts**:
  ...
  - [`src/exp07/train_classical_gcn.py`](../../src/exp07/train_classical_gcn.py)
...
- **Canonical Notebooks**:
  - [`notebooks/exp08/neuro.ipynb`](../../notebooks/exp08/neuro.ipynb)
  - [`notebooks/exp08/true_neuro.ipynb`](../../notebooks/exp08/true_neuro.ipynb)
  - [`notebooks/exp08/09_temporal_graph_learning.ipynb`](../../notebooks/exp08/09_temporal_graph_learning.ipynb)
...
- **Staged Result Artifacts**:
  - [`results/exp09/w2b_loso_results.csv`](../../results/exp09/w2b_loso_results.csv)
...
- **Discrepancy: Paper Description vs. Executed Code**:
  ...
  - *Executed Code* ([`configs/exp09/graph_preprocessing_config.json`](../../configs/exp09/graph_preprocessing_config.json) & notebook): Top-10% thresholding (empirical density 0.10003, mean edges 3,782), raw weighted connectivity features, self-loops added ($A + I$).
  - *Status*: **DOCUMENTED DISCREPANCY**.
- **Recorded Execution Environment**:
  - Frozen in [`configs/exp09/w2b_environment.json`](../../configs/exp09/w2b_environment.json): Python 3.12.13, PyTorch 2.5.1+cu121, CUDA 12.1, PyG 2.8.0, NumPy 2.4.6, Pandas 2.3.3, Scikit-Learn 1.8.0, Nilearn 0.13.1, Nibabel 5.4.2, PennyLane 0.44.1, MONAI 1.5.2, running on NVIDIA A100-SXM4-80GB (Azure Linux 6.17 glibc 2.39).
- **Status**: **ARTIFACT-VERIFIED**.
